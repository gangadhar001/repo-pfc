...
En esta última iteración de la fase de construcción, se diseñan, implementan y prueban los casos de uso que componen la funcionalidad de \textit{Exportar conocimiento}, mostrados en la Figura \ref{fig:CduExportarConocimientoServer}, y la funcionalidad de \textit{Gestión de idiomas} (ver Figura \ref{fig:CduGestionIdiomasServer}).
