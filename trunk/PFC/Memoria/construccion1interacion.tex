...
Siguiendo los casos de uso de la funcionalidad de \textit{Visualizar decisiones} (ver Figura \ref{fig:CduVisualizarDecisiones2Server}), así como su análisis realizado, se abordan las siguientes tareas en esta primera iteración de la fase de Construcción: 

\begin{itemize}
	\item Diseño de la funcionalidad relativa a la visualización de información en el sistema, como son las decisiones y toda su información asociada.
	\item Implementación de dicha funcionalidad.
	\item Diseño e implementación de pruebas unitarias y funcionales relativas a la visualización de información.
\end{itemize}

\subsubsection{Funcionalidad de \textit{Visualizar información}}
...
\imagen{Cap5/Cliente2//secuenciaConsultarDecisionesPrincipalCliente}{2.0}{Diagrama de secuencia - Cliente - Consultar decisiones}{fig:secuenciaConsultarDecisionesCliente}

\imagen{Cap5/Server2//secuenciaConsultarDecisionesPrincipalServer}{2.0}{Diagrama de secuencia - Servidor - Consultar decisiones}{fig:secuenciaConsultarDecisionesServer}


\subparagraph{Visualizar compañía}

En la Figura \ref{fig:secuenciaConsultarCompanyiaCliente} se muestra el diagrama de secuencia para el caso de uso \textit{Consultar compañía} en el cliente, mientras que en la Figura \ref{fig:secuenciaConsultarCompanyiaServer} se muestra el diagrama de secuencia para el servidor.

\imagen{Cap5/Cliente2//secuenciaConsultarCompanyiaCliente}{2.0}{Diagrama de secuencia - Cliente - Consultar compañía}{fig:secuenciaConsultarCompanyiaCliente}

\imagen{Cap5/Server2//secuenciaConsultarCompanyiaServer}{2.0}{Diagrama de secuencia - Servidor - Consultar compañía}{fig:secuenciaConsultarCompanyiaServer}
...
\imagen{Cap5/Cliente2//secuenciaConsultarAdjuntosPrincipalCliente}{2.0}{Diagrama de secuencia - Cliente - Descargar ficheros adjuntos}{fig:secuenciaConsultarAdjuntosCliente}

\imagen{Cap5/Server2//secuenciaConsultarAdjuntosPrincipalServer}{2.0}{Diagrama de secuencia - Servidor - Descargar ficheros adjuntos}{fig:secuenciaConsultarAdjuntosServer}


\paragraph{Diseño e implementación} \label{sec:visualizarDecisiones}

Siguiendo los diagramas de secuencia, se realiza el diseño de los casos de uso utilizando un diagrama de clases de diseño y se procede a la implementación de dichos casos de uso, para obtener las clases Java que dan soporte a estas funcionalidades. A continuación se destacan algunos aspectos tenidos en cuenta al diseñar e implementar estos casos de uso.
...
Como se comentó en la última iteración de la fase de elaboración, la interfaz del cliente sigue una jerarquía de composición de clases para mostrar la información y construir su interfaz gráfica. En el diagrama de la Figura \ref{fig:clasesUIDecisiones} se puede apreciar esta organización de clases de la interfaz gráfica. 

\imagen{Cap5/Cliente2//clasesUIDecisiones}{0.7}{Diagrama de clases - Composición de clases de interfaz gráfica}{fig:clasesUIDecisiones}
