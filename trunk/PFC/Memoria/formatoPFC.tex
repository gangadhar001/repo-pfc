...
\newcommand{\director}{Aurora Vizcaino Barcelo}
%\newcommand{\tutor}{M\textordfeminine{} Ángeles Moraga de la Rubia}
\newcommand{\titulopfc}{GCAD: Sistema cliente/servidor para la gestión de conocimiento en desarrollo distribuido de software.}
