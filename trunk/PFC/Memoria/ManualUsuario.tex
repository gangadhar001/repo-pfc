\chapter{Manual de usuario de GCADServer}
\label{ch:manualServer}

\textit{GCADServer} es el servidor que debe encontrarse en ejecución para poder ejecutar la mayoría de las funcionalidades de la herramienta \textit{GCADClient}. 

Esta herramienta necesitará un servidor de bases de datos MySQL activo, bien en la misma máquina o en otra.
