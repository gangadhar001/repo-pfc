...
entre objetos) y pruebas de sistema (comunicación entre subsistemas), basándose en una combinación de los enfoques de
...
problemas de integridad e inconsistencias en las bases de datos, no pudiéndose dar éstas, debido
...
\setlength\fboxrule{0.5pt}
 ...
 \caption{Informe de cobertura para la capa de control de la lógica de dominio del sistema servidor}
