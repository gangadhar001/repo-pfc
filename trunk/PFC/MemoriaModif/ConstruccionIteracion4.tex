...
Como se puede comprobar, algunos casos de prueba no fueron superados, ya que no se obtenía el resultado descrito. Por tanto, se corrigieron estos fallos detectados y se volvieron a ejecutar todos los casos creados en la \textit{checklist}, hasta obtener un resultado positivo en todos ellos.