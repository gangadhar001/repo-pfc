...
Siguiendo los casos de uso del grupo funcional \textbf{F2:} \textit{Gestión de decisiones} y del grupo funcional \textbf{F4:} \textit{Gestión de notificaciones}, se abordan las siguientes tareas en esta iteración:
...
Es esta iteración se diseñan e implementan ambos grupos funcionales porque éstos están estrechamente relacionados, ya que en la gestión de decisiones se incluye la creación de notificaciones de manera automática.
...
\begin{tabular}{| >{\arraybackslash}m{15cm} |}
	...
	\hline
	\textbf{Descripción}: Funcionalidad para modificar una Propuesta en un proyecto. 	\\
	\hline
...
\imagenBorde{Cap5/Pruebas//pruebasKnowledge}{0.8}{\textit{Test Suite} para la gestión de decisiones en el servidor}{fig:testKnowledge}
