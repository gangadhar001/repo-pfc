...
\item \textbf{Intervalo}: función utilizada para evaluar la semejanza entre los valores de dos atributos, dentro de un intervalo. Así, esta función se describe como: \texttt{|x-y|/interval}. El resultado se normaliza al intervalo [0,1].
\end{itemize}
