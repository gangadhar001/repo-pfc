...
\subsubsection{Grupo Funcional \textbf{F4:} \textit{Gestión de proyectos}}
...
\imagen{Cap5/Server2//secuenciaCrearProyectosServer}{1.6}{Diagrama de secuencia - Servidor - Crear proyecto}{fig:secuenciaCrearProyectosServer}
...
\imagen{Cap5/Server2//secuenciaCBRServer}{2.3}{Diagrama de secuencia - Servidor - Aconsejar decisiones}{fig:secuenciaCBRServer}
...
%% EXPLICAR COMO CONFIGURAR EL CBR Y REFLEXION PARA MOSTAR VALORES
