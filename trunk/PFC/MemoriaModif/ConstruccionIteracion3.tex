...
Como se indicó al comienzo de este capítulo, sólo se han incluido las pruebas de aquellos aspectos mas reseñables del sistema, para evitar exceder la longitud del documento, por lo que en esta iteración no se muestran los resultados de las pruebas, aunque puede consultarse el Apéndice \ref{appendix:cobertura} para comprobar los resultados de las pruebas en todo el sistema, junto a la cobertura alcanzada.
