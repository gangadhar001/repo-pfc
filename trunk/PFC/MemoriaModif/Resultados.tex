...
Para evitar que este capítulo sea demasiado extenso, no se profundiza del mismo modo en todas las fases e iteraciones, ni se han incluido todos los diagramas que se han realizado, especialmente en las iteraciones de análisis y diseño, debido a la gran cantidad de diagramas generados por estas disciplinas. Por otro lado, se incluyen fragmentos de código fuente que tienen especial relevancia e interés en el sistema.