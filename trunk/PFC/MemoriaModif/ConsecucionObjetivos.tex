...
Consideramos que este objetivo ha sido conseguido gracias al diseño y construcción de la aplicación, basada en Java, que ha sido detallada y comentada a lo largo del documento, especialmente en el capítulo \ref{ch:resultados}.

A continuación, se explica la consecución del resto de sub-objetivos planteados en el capítulo \ref{ch:motivacionyobjetivos}, y resumidos en la Tabla{\ref{table:objetivos}.
...
Para facilitar la gestión de decisiones tomadas en proyectos software, se han diseñado e implementado funcionalidades para la creación de decisiones, para su modificación, eliminación, etc. Por tanto, el sistema provee un mecanismo que facilita y favorece dicha gestión, además de la comunicación entre equipos de desarrollo, ya que al utilizar formularios y estructuras comunes a todos ellos, se minimizan los malentendidos y ambigüedades.
