...
Como principal inconveniente de utilizar RMI, se puede destacar el problema de utilizarlo junto a Hibernate, ya que al serializar y transferir los objetos remotos, estas referencias no son las mismas que las referencias que mantiene Hibernate para gestionar su modelo de objetos persistentes, por lo que se encontraron problemas a la hora de, por ejemplo, modificar objetos en la base de datos cuando el cliente había realizado cambios en ellos. Sin embargo, este problema quedó solucionado clonando los objetos que fueron serializados por RMI y que deben modificarse en la base de datos, usando Hibernate.
