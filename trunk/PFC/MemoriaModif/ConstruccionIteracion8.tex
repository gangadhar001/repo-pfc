...
Siguiendo los casos del grupo funcional \textbf{F8:} \textit{Exportar información} (ver Figura \ref{fig:CduExportarConocimiento2Server}) y del grupo funcional \textbf{F9:} \textit{Gestión de idiomas} (ver Figura \ref{fig:CduGestionIdiomas2Server}), se abordan las siguientes tareas en esta iteración:
