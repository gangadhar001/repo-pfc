...
% Para llegar hasta subsubsecciones en el indice
\setcounter{secnumdepth}{3}
\setcounter{tocdepth}{3}

% Color de las tablas
\newcommand{\colorCabecera}{\cellcolor[gray]{0.6}}
\newcommand{\colorCelda}{\cellcolor[gray]{0.9}}
...
% -------- Datos del PFC ----------------- %
\newcommand{\autor}{Juan Andrada Romero} % Aquí tu nombre
\newcommand{\director}{Aurora Vizcaíno Barceló}
\newcommand{\titulopfc}{DPMTool: Sistema Distribuido para la Gestión de Decisiones de Proyectos Software en Desarrollo Global de Software}
...
\lstdefinelanguage{xml}
{
  morestring=[b]",
  morestring=[s]{>}{<},
  morekeywords={<?, ?>, xml, encoding, xmlns,version,type}% list your attributes here
}

\lstdefinelanguage{mysql}
{
  morestring=[b]",
  morekeywords={CREATE, TRIGGER, AFTER, DELETE, ON, FOR, EACH, ROW, BEGIN, DECLARE, INT, IF, SELECT, COUNT, INTO, FROM, WHERE, old, THEN, DELETE, OLD, END, END\$\$}% list your attributes here
}
...
{
	language=xml,           % Lenguaje de programación del código
	basicstyle=\scriptsize,
  % numbers=left,
  % numberstyle=\footnotesize,
  % stepnumber=2,
...
{
	language=mysql,           % Lenguaje de programación del código
	basicstyle=\scriptsize,
  % numbers=left,
  % numberstyle=\footnotesize,
  % stepnumber=2,
...
% Salto de línea tras título de secciones \subparagraph
\makeatletter % necesario para que reconozca a '@' como carácter normal
\renewcommand{\subparagraph}{\@startsection{subparagraph}{5}{\z@}{-3.25ex \@plus
-1ex \@minus -.2ex}{1.5ex \@plus .2ex}{\normalfont\bfseries}}
\makeatother % necesario para que restablezca '@' como carácter especial
