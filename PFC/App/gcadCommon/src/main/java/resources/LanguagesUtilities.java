...
public class LanguagesUtilities {
	...
	public static ArrayList<Language> getLanguages() throws JDOMException, IOException {
		...
		doc = builder.build(LanguagesUtilities.class.getClassLoader().getResource(LANGUAGES_FILE));
	...
	public static void setDefaultLanguage(Language language) throws JDOMException, IOException {
		...
		FileWriter fw = new FileWriter(new File(LanguagesUtilities.class.getClassLoader().getResource(LANGUAGES_FILE).getPath()));
