...
En el fragmento de código \ref{list:observador}, incluido en el Apéndice \ref{appendix:remote}, se muestra parte de la implementación de la clase controlador de los clientes, mientras que el fragmento \ref{list:hilos} que aparece en el Apéndice \ref{appendix:hilos} refleja como se ha implementado la gestión de hilos para notificar a los clientes. La clase encargada de esto último además representa un patrón \textbf{proxy}, ya que los clientes son remotos.
