...
Por otro lado, para comprobar el correcto funcionamiento de la interfaz gráfica de usuario para los casos de uso, se han creado \textit{cecklists}, como en casos anteriores, donde se muestra en la Tabla \ref{table:checkCBR}, a modo de ejemplo relevante, parte de la \textit{checklist} utilizada para probar la interfaz asociada al CBR.
