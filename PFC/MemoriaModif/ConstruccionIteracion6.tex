...
Siguiendo los casos de uso del grupo funcional \textbf{F5:} \textit{Gestión de proyectos}, se abordan las siguientes tareas en esta iteración:
...
Hay que señalar que esta funcionalidad incluye el comportamiento de los casos de uso \textit{Consultar decisiones} y \textit{Consultar proyectos}, por lo que dichos comportamientos se muestran de manera simplificada en estos diagramas de secuencia, ya que han sido modelados en iteraciones anteriores a esta.
...
Para terminar, en el fragmento de código \ref{list:cbr} del Apéndice \ref{appendix:codigo}, se muestra la implementación del algoritmo \textit{NN}, haciendo uso del diseño y elementos comentados anteriormente. Un aspecto a señalar es el uso del API de reflexión de Java, utilizado para acceder a los atributos de un proyecto en tiempo de ejecución.
...
\imagenBorde{Cap5/Pruebas//pruebasProjects}{0.8}{\textit{Test Suite} para la gestión de proyectos en el servidor}{fig:testProyectos}
