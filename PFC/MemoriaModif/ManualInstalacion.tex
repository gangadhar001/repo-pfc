...
\imagen{Apendices/Manual//java-version}{0.55}{Cómo averiguar la versión de Java}{fig:java-version}
...
\imagen{Apendices/Manual//javahome}{0.60}{Variable de sistema JAVA\_HOME}{fig:javahome}
...
Con ello, queda instalado el servidor MySQL y configurada la base de datos que va a utilizarse y gestionarse con el sistema DPMTool. Recordar que es necesario iniciar el servicio de MySQL antes de activar el servidor del sistema DPMTool - Server.