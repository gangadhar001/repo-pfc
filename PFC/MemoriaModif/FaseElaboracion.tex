...
En la Tabla \ref{table:categorias2} se muestran los nuevos grupos de requisitos, incluyendo los nuevos requisitos que se han identificado.
...
\imagen{Cap5/Cliente2/casos2Cliente}{1.0}{Diagrama de casos de uso - Cliente - v2.0}{fig:casos2Cliente}
...
\imagen{Cap5/Cliente2//CduVisualizarDecisiones}{1.0}{Diagrama de casos de uso - Cliente - Visualizar información - v2.0}{fig:CduVisualizarDecisiones2Cliente}

\imagen{Cap5/Server2//CduVisualizarDecisiones}{2.0}{Diagrama de casos de uso - Servidor - Visualizar información - v2.0}{fig:CduVisualizarDecisiones2Server}
...
\imagen{Cap5/Cliente2//CduGestionDecisiones}{1.0}{Diagrama de casos de uso - Cliente - Gestión decisiones - v2.0}{fig:CduGestionDecisiones2Cliente}
...
\begin{tabular}{| >{\arraybackslash}m{15cm} |}
	...
	\item El jefe de proyecto introduce un título y descripción para el Tema.
	\item El sistema valida los datos introducidos.
	\item Los datos son incompletos. Se muestra un mensaje y se vuelven a solicitar los datos del Tema.
	\vspace{-4mm}
	\end{enumerate}	
	\\
	\hline
	\textbf{Flujo alternativo 2: Tema ya existente}:
	\begin{enumerate}
	\vspace{-4mm}
	\setlength{\itemsep}{-7.5pt}
	\setlength{\parsep}{\itemsep}
	...
	\item El jefe de proyecto introduce un título y descripción para el Tema.
	\item El sistema valida los datos introducidos.
	\item Ya existe ese Tema. Se muestra un mensaje y se vuelven a solicitar los datos.
	\vspace{-4mm}
	\end{enumerate}
	\\
	\hline
...
\begin{tabular}{| >{\arraybackslash}m{15cm} |}
	...
	\item El usuario introduce los datos de la nueva Propuesta.
	\item El sistema valida los datos introducidos.
	\item Ya existe esa Propuesta. Se muestra un mensaje y se vuelven a solicitar los datos.
	\vspace{-4mm}
	\end{enumerate}
	\\
	\hline
\end{tabular}
\caption{Especificación del caso de uso \textit{Crear decisión - Crear Propuesta}}
...
\begin{tabular}{| >{\arraybackslash}m{15cm} |}
	...
	\item El usuario introduce los datos de la nueva Respuesta.
	\item El sistema valida los datos introducidos.
	\item Los datos son incompletos. Se muestra un mensaje y se vuelven a solicitar los datos de la Respuesta.
	\vspace{-4mm}
	\end{enumerate}	
	\\
	\hline
	\textbf{Flujo alternativo 2: Respuesta ya existente}:
	\begin{enumerate}
	\vspace{-4mm}
	\setlength{\itemsep}{-7.5pt}
	\setlength{\parsep}{\itemsep}
	...
	\item El usuario introduce los datos de la nueva Respuesta.
	\item El sistema valida los datos introducidos.
	\item Ya existe esa Respuesta. Se muestra un mensaje y se vuelven a solicitar los datos.
	\vspace{-4mm}
	\end{enumerate}
	\\
	\hline
...
\begin{itemize}
	\item Diseño de clases del dominio.
	\item Diseño de la base de datos.
	\item Definición y diseño de la arquitectura del sistema.
	\item Implementación del control de acceso al sistema, así como la implementación de la arquitectura cliente-servidor.
	\item Diseño e implementación de pruebas unitarias y funcionales relativas a la comunicación entre ambos subsistemas y del acceso al sistema.
\end{itemize}
...
quién, cuándo y qué acción se ha realizado. Es una clase persistente.
\end{itemize}
...
del sistema, como, por ejemplo, iniciar o detener el servidor.
	\item Debido a las asociaciones n:m (o \textit{muchos a muchos}) entre las clases de \textit{User} y \textit{Project}, y entre las de \textit{Notification} y \textit{User}, es necesario modelar tablas adicionales que permitan modelar dichas asociaciones, utilizando claves ajenas a las tablas que representan las clases que participan en esas asociaciones.
...
Para terminar, cabe destacar que este modelo se ha creado utilizando la herramienta \textbf{MySQL Workbench} (ver sección \ref{sec:marco}), la cuál permite generar el código SQL necesario para crear las tablas y relaciones de la base de datos a partir de ese modelo, aplicando ingeniería directa.
...
\imagen{Cap5/Cliente2//secuenciaLogoutPrincipalCliente}{2.0}{Diagrama de secuencia - Cliente - Logout}{fig:secuenciaLogoutCliente}
