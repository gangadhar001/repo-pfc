...
\begin{tabular}{| >{\centering\arraybackslash}m{6cm} | >{\arraybackslash}m{6cm} | >{\centering\arraybackslash}m{2cm} |}
	...
	\multicolumn{1}{|c|}{\colorCelda \textbf{F8:} Gestión Idiomas} & 
		 Cambiar idioma & \textbf{F8.1} \\ \cline{2-3}
	\hline
...
{| >{\centering\arraybackslash}m{3cm} | >{\centering\arraybackslash}m{1.9cm} | >{\arraybackslash}m{9.2cm} |}
	...
	\hline
\end{tabular}
\caption{Versión definitiva del plan de iteraciones}
...
En la Figura \ref{fig:paquetes} puede observarse un diagrama de paquetes reflejando esta arquitectura multicapa y las relaciones entre dichas capas.

\imagen{Cap5/Server2//DivisionCapas}{2.2}{Relaciones entre capas}{fig:paquetes}
