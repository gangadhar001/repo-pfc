...
Como se comentó al inicio de este capítulo, para no excederse en la longitud de éste, y por tanto de todo el presente documento, se incluyen las especificaciones y diagramas de análisis de los principales casos de uso que componen el sistema.
