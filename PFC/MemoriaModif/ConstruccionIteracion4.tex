...
\begin{table}[!htbp]%
	...
	\hline
		...
		Se informa al usuario, mediante una barra de progreso, que la acción de mostrar las decisiones en su vista está en progreso y que debe esperar &
		\ding{'065} \\
	\hline 
	...
	\hline
		...
		Cuando el usuario selecciona o desmarcar una decisión, se habilitan/deshabilitan en consecuencia los elementos de la barra de herramientas (\textit{toolbar)} &
		\ding{'063} \\
		\hline
