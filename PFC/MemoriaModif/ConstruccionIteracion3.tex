...
Siguiendo los casos del grupo funcional \textit{F1: Acceso al sistema} (ver Figura \ref{fig:CduVisualizarDecisiones2Server}), se abordan las siguientes tareas en esta primera iteración de la fase de Construcción: 
