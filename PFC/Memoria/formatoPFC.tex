...
% Color de las tablas
\newcommand{\colorCabecera}{\cellcolor[gray]{0.4}}
...
\newcommand{\titulopfc}{GCAD: Sistema Cliente/Servidor para la Gestión de Decisiones en Desarrollo Distribuido de Software.}
