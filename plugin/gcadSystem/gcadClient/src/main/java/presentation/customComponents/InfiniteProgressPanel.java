...
//REFERENCE: http://jroller.com/gfx/date/20050215

/***
 * Class used to create and show an animated spinner loading
 *
 */
public class InfiniteProgressPanel extends JComponent implements MouseListener
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8109468335296766131L;
	protected Area[]  ticker     = null;
    protected Thread  animation  = null;
    protected boolean started    = false;
    protected int     alphaLevel = 50;
    protected int     rampDelay  = 300;
    protected float   shield     = 0.80f;
    protected String  text       = "";
    protected int     barsCount  = 15;
    ...
    public void paintComponent(Graphics g)
    {
        if (started)
        {
            ...
            if (text != null && text.length() > 0)
            {
	            ...
	            TextLayout layout = new TextLayout(text, getFont().deriveFont(Font.BOLD, 16f), context);
