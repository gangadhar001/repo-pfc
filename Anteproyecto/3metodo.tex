...
Debido al enfoque iterativo e incremental que caracteriza al PUD, éste se divide en ciclos, donde cada ciclo se compone de cuatro fases y éstas, a su vez, se dividen en iteraciones que siguen el flujo de trabajo \textit{requisitos, análisis, diseño, implementación y pruebas}.
