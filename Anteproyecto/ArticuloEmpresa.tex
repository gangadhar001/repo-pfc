...
\hypersetup{bookmarksopen,bookmarksopenlevel=3,linktocpage,colorlinks,urlcolor=blue,citecolor=blue,
						...
						pdftitle={Plug-in de Eclipse para la gestión de conocimiento en las fases de análisis y diseño de desarrollo distribuido},
